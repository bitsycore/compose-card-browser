package com.bitsycore.toploader.data.net
...
data class ProviderHttpPolicy(
	...
	companion object {
		...
		/**
		 * What every source sees us as.
		 *
		 * The version is spelled here rather than read from `AppBuild`, which lives in `:composeApp`
		 ...
		 */
		const val DEFAULT_USER_AGENT: String = "Toploader/1.0 (+https://github.com/bitsycore)"
