 ...
 */
data class SetCards(
	val cards: List<com.bitsycore.tcgexplorer.core.model.CardPrinting>,
...
data class OpeningLanguage(
	val language: com.bitsycore.tcgexplorer.core.model.CardLanguage?,
	val substitutedFor: com.bitsycore.tcgexplorer.core.model.CardLanguage? = null,
...
data class GameStorage(
	val game: com.bitsycore.tcgexplorer.core.model.GameId,
	val sets: Int,
	val extraSets: Int = 0,
	val languages: Map<com.bitsycore.tcgexplorer.core.model.CardLanguage, Int> = emptyMap(),
	val bytes: Long,
	/**
 ...
 *   [com.bitsycore.tcgexplorer.core.model.CardLanguage]: "the source never said" is a real state and
 *   has no enum value
...
data class KeptSet(
	...
	val language: com.bitsycore.tcgexplorer.core.model.CardLanguage?
		get() = com.bitsycore.tcgexplorer.core.model.CardLanguage.fromCode(languageCode)
