	...
	private fun graph() = startKoin {
		modules(
			...
			module {
				...
				single<com.bitsycore.tcgexplorer.data.cache.SetRecordStore> {
					com.bitsycore.tcgexplorer.data.cache.InMemorySetRecordStore()
				}
				// Metadata lives in the same database, so it is overridden on the same terms.
				single<com.bitsycore.tcgexplorer.data.cache.MetadataStore> {
					com.bitsycore.tcgexplorer.data.cache.InMemoryMetadataStore()
				}
				single<com.bitsycore.tcgexplorer.platform.LinkOpener> {
					object : com.bitsycore.tcgexplorer.platform.LinkOpener {
