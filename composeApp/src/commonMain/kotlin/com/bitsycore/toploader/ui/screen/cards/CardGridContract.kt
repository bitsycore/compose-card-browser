...
object CardGridContract :
	...
	data class UiState(
		...
		val supportedFilters: Set<com.bitsycore.toploader.core.provider.CardFilterField> = emptySet(),
	...
	sealed interface Intent {
		...
		data class CapabilitiesResolved(
			val supportedFilters: Set<com.bitsycore.toploader.core.provider.CardFilterField>,
