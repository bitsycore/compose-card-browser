...
// Disney Lorcana: what the app knows about the game itself, independent of any source that serves it.
...
kotlin {
	...
	android {
		namespace = "com.bitsycore.cardbrowser.games.lorcana"
...
compose.resources {
	packageOfResClass = "com.bitsycore.cardbrowser.games.lorcana.resources"
