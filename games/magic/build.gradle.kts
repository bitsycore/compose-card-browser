...
// Magic: The Gathering: what the app knows about the game itself, independent of any source that serves it.
...
kotlin {
	...
	android {
		namespace = "com.bitsycore.tcgexplorer.games.magic"
...
compose.resources {
	packageOfResClass = "com.bitsycore.tcgexplorer.games.magic.resources"
