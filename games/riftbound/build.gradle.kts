...
// Riftbound: what the app knows about the game itself, independent of any source that serves it.
...
kotlin {
	...
	android {
		namespace = "com.bitsycore.cardbrowser.games.riftbound"
...
compose.resources {
	packageOfResClass = "com.bitsycore.cardbrowser.games.riftbound.resources"
