...
kotlin {
	...
	android {
		namespace = "com.bitsycore.tcgexplorer.providers.wuwa"
...
compose.resources {
	...
	packageOfResClass = "com.bitsycore.tcgexplorer.providers.wuwa.resources"
...
val vCheckAndroidAsset = tasks.register("androidAssetIsPackaged") {
	...
	val vExpected = "assets/composeResources/com.bitsycore.tcgexplorer.providers.wuwa.resources/" +
