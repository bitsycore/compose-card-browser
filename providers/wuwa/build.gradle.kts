...
// The UCP Wuthering Waves TCG adapter: its endpoints, its DTOs, the mapping into core's model, and its own declared
// capabilities. Nothing outside this module knows what UCP Wuthering Waves TCG's JSON looks like.
kotlin {
	jvmToolchain(21)
...
/** Hits the real UCP Wuthering Waves TCG API. Run deliberately: `./gradlew :providers:wuwa:liveProviderTest`. */
tasks.register<Test>("liveProviderTest") {
	group = "verification"
	description = "Runs the UCP Wuthering Waves TCG smoke checks against the live API. Needs a network."
