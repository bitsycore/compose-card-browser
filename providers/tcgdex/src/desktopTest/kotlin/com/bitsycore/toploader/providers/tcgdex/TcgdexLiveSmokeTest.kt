...
class TcgdexLiveSmokeTest {
		...
		runBlocking {
			...
			val vPage = provider().listCards(
				CardPageRequest(
					...
					query = com.bitsycore.toploader.core.provider.CardQuery(),
					page = 1,
					pageSize = 500,
	...
	fun `a Cardmarket product id really is attached to a printing`() = runBlocking {
		...
		assertNotNull(vCard)
		val vProduct = vCard.externalIds[com.bitsycore.toploader.core.model.ExternalIdKey.CARDMARKET_PRODUCT]
