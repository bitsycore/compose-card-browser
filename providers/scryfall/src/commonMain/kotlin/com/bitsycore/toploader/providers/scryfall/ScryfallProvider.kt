...
import com.bitsycore.toploader.core.provider.Attribution
...
import com.bitsycore.toploader.data.net.ProviderHttpPolicy
import kotlin.time.Duration.Companion.milliseconds
import com.bitsycore.toploader.data.net.mapProviderErrors
...
class ScryfallProvider(
	...
	companion object {
		...
		val HTTP_POLICY: ProviderHttpPolicy = ProviderHttpPolicy(
			userAgent = "Toploader/1.0 (github.com/bitsycore)",
		...
		private const val USER_AGENT = "Toploader/1.0 (github.com/bitsycore)"
	}
}
