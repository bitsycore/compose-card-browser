...
// The Altered TCG Card Database adapter: its endpoints, its DTOs, the mapping into core's model, and its own declared
// capabilities. Nothing outside this module knows what Altered TCG Card Database's JSON looks like.
kotlin {
	jvmToolchain(21)
	...
	android {
		namespace = "com.bitsycore.cardbrowser.providers.altered"
...
/** Hits the real Altered TCG Card Database API. Run deliberately: `./gradlew :providers:altered:liveProviderTest`. */
tasks.register<Test>("liveProviderTest") {
	group = "verification"
	description = "Runs the Altered TCG Card Database smoke checks against the live API. Needs a network."
