package com.bitsycore.toploader.core.provider
...
data class CardQuery(
	...
	val treatments: Set<com.bitsycore.toploader.core.model.ArtworkTreatment> = emptySet(),
	val finishes: Set<com.bitsycore.toploader.core.model.Finish> = emptySet(),
